...
def get_tokenizer_pile(tokenizer_parent_dir=None):
    """
    Load or download the tokenizer used for the JonasGeiping WordPiece pile dataset.
    ...
    logger.info(f"Tokenizer parent dir: {tokenizer_parent_dir}")
