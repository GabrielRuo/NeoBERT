#!/bin/bash
#SBATCH --job-name=bert-ablations-08
...
cmd=(
    ...
    dataloader.train.pack_sequences=true \
    dataset.path_to_disk=tokenized_datasets/falcon-refinedweb_google_4096 \
)
# This was done with fixed length batch sizes (packed or truncated)
