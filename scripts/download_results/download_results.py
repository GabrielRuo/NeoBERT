...
#CAREFUL: imperfect code, use delete_in_modal=False to avoid accidentally 
#deleting runs from modal

#This file downloads the runs logs from modal and saves them locally under runs/logs.
#  It can download all the runs logs or specific checkpoints of specific runs.
#  It can also delete the runs logs from modal after downloading them.
...
local_logs_dir = project_root / "runs" / "logs"
